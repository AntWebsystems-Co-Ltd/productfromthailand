...
<div class="head2">Supplier's Helps</div>
            <div class="tabletext">On this help will explain you how to create a product on the system and how to upload your products from a spread sheet. </div>
            <div class="head2">How to Create a product ?</div>
            <div class="tabletext">
                <ol>
                    <li>To create a product first you need to <a href="<@ofbizUrl>../../myportal</@ofbizUrl>">log on</a> to the system.</li>
                    <li>You will see the button called "Products" then click on that.</li>
                    <li>After that, "New Product" then put the information about the product you want to create.
                        You can leave the field "Product Id" empty the system will auto generate it for you then press "Create Product"</li>
