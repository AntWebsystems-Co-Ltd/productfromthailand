												...
												<td>
													<ul id="left-links">
												      ...
												      <#else/>
												        ...
												        <li id="header-bar-login"><a href="<@ofbizUrl>newcustomer</@ofbizUrl>"><h2>${uiLabelMap.EcommerceRegister}</h2></a></li>
												      </#if>
...
<div id="main">
  <div id="ecom-header">
	  <table cellspacing="0" cellpadding="0" border="0">
	  	<tbody>
	  		<tr>
	  			<td background="/productfromthailand/images/bg01.gif" width="800" align="center">
	  				<br>
	  				<div id="menubar">
					    <ul id="right-links">
