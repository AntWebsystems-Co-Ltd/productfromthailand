    ...
    <div class="screenlet-body">
      <form name="contactus" method="post" action="<@ofbizUrl>${submitRequest}</@ofbizUrl>" style="margin: 0;">
        ...
        <table width="100%" border='0' cellspacing='0' cellpadding='0' class='boxbottom'>
          ...
          <tr>
            <td width="5">&nbsp;</td>
            <td align="left"><div class="tableheadtext">${uiLabelMap.CommonFrom}:</div></td>
          ...
          <#if partyIdTo?has_content>
            ...
            <tr>
              <td width="5">&nbsp;</td>
              <td align="left"><div class="tableheadtext">${uiLabelMap.CommonTo}:</div></td>
          ...
          <tr>
            <td width="5">&nbsp;</td>
            <td align="left"><div class="tableheadtext">${uiLabelMap.EcommerceSubject}:</div></td>
          ...
          <tr>
            <td width="5">&nbsp;</td>
            <td align="left"><div class="tableheadtext">${uiLabelMap.CommonMessage}:</div></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
