...
<div class="screenlet">
  <div class="boxlink">
    ...
    <#if person?exists || partyGroup?exists>${uiLabelMap.CommonUpdate}<#else>${uiLabelMap.CommonCreate}</#if></a>
  </div>
  <#if person?exists>
    ...
    <div>
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <#elseif partyGroup?exists>
          <td align="right">${uiLabelMap.CommonPartyGroupName}</td>
          <td>
            ${partyGroup.groupName?if_exists}
          </td>
          </#if>
...
<#if person?exists>
  <div>
    <div class="screenlet">
      ...
      <table width="100%" border="0" cellpadding="0" id="orderSalesHistory" summary="This table display order sales history.">
        <thead>
          <tr>
