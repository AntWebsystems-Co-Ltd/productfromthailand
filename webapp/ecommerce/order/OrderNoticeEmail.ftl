...
<body>
  ...
  <#if note??><p>${note}</p></#if>
  <#if orderHeader??>
  ${screens.render("component://productfromthailand/widget/OrderScreens.xml#OrderHeaderNotice")}
  <br/>
  ${screens.render("component://productfromthailand/widget/OrderScreens.xml#OrderItemsNotice")}
  <#else>
