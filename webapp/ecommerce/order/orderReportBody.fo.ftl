       ...
       <fo:table-header>
           ...
           <#list orderItemList as orderItem>
                 ...
                 <#assign itemAdjustment = Static["org.apache.ofbiz.order.order.OrderReadHelper"].getOrderItemAdjustmentsTotal(orderItem, orderAdjustments, true, false, false)>
                  <fo:table-row>
                       ...
                       <#if itemAdjustment != 0>
                       <fo:table-row>
                        <fo:table-cell number-columns-spanned="2"><fo:block text-indent="0.2in"><fo:inline font-style="italic">${uiLabelMap.OrderAdjustments}</fo:inline>: <@ofbizCurrency amount=itemAdjustment*conversionRate isoCode=currencyUom/><#--@ofbizCurrency amount=itemAdjustment isoCode=currencyUomId/--></fo:block></fo:table-cell>
                    </fo:table-row>
                    </#if>
           </#list>
          <#list orderHeaderAdjustments as orderHeaderAdjustment>
            ...
            <fo:table-row>
               ...
               <fo:table-cell text-align="right"><fo:block><@ofbizCurrency amount=adjustmentAmount*conversionRate isoCode=currencyUom/><#--@ofbizCurrency amount=adjustmentAmount isoCode=currencyUomId/--></fo:block></fo:table-cell>
            </fo:table-row>
            </#if>
          </#list>
           ...
           <#-- summary of order amounts -->
                    <fo:table-row>
                        ...
                        <fo:table-cell text-align="right"><fo:block><@ofbizCurrency amount=orderSubTotal*conversionRate isoCode=currencyUom/><#--@ofbizCurrency amount=orderSubTotal isoCode=currencyUomId/--></fo:block></fo:table-cell>
                    </fo:table-row>
                  <#if otherAdjAmount != 0>
                    <fo:table-row>
                        <fo:table-cell></fo:table-cell>
                        ...
                        <fo:table-cell text-align="right"><fo:block><@ofbizCurrency amount=otherAdjAmount*conversionRate isoCode=currencyUom/><#--@ofbizCurrency amount=otherAdjAmount isoCode=currencyUomId/--></fo:block></fo:table-cell>
                    </fo:table-row>
                  </#if>
                  <#if shippingAmount != 0>
                    <fo:table-row>
                        ...
                        <fo:table-cell text-align="right"><fo:block><@ofbizCurrency amount=shippingAmount*conversionRate isoCode=currencyUom/><#--@ofbizCurrency amount=shippingAmount isoCode=currencyUomId/--></fo:block></fo:table-cell>
                    </fo:table-row>
                  </#if>
                  <#if taxAmount != 0>
                    <fo:table-row>
                        ...
                        <fo:table-cell text-align="right"><fo:block><@ofbizCurrency amount=taxAmount*conversionRate isoCode=currencyUom/><#--@ofbizCurrency amount=taxAmount isoCode=currencyUomId/--></fo:block></fo:table-cell>
                    </fo:table-row>
                  </#if>
                  <#if grandTotal != 0>
                    <fo:table-row>
                        ...
                        <fo:table-cell text-align="right"><fo:block><@ofbizCurrency amount=grandTotal*conversionRate isoCode=currencyUom/><#--@ofbizCurrency amount=grandTotal isoCode=currencyUomId/--></fo:block></fo:table-cell>
                    </fo:table-row>
                  </#if>
