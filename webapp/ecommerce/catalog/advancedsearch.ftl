  ...
  <table width="100%">
    ...
    <tr valign="middle">
      ...
      <td><input type="text" name="SEARCH_STRING" size="40" value="${requestParameters.SEARCH_STRING?if_exists}">
          <input type="radio" name="SEARCH_OPERATOR" value="OR" <#if searchOperator == "OR">checked</#if>> ${uiLabelMap.CommonAny}
          <input type="radio" name="SEARCH_OPERATOR" value="AND" <#if searchOperator == "AND">checked</#if>> ${uiLabelMap.CommonAll}
      </td>
    </tr>
    ...
    <tr valign="middle">
      ...
      <td>
          ...
          <input type="radio" name="sortAscending" value="Y" checked="checked"/> ${uiLabelMap.EcommerceLowToHigh}
          <input type="radio" name="sortAscending" value="N"/> ${uiLabelMap.EcommerceHighToLow}
      </td>
    </tr>
    <#if searchConstraintStrings?has_content>
      <tr valign="top">
        ...
        <td>
            ...
            <div>
              <input type="radio" name="clearSearch" value="Y" checked="checked"/> ${uiLabelMap.ProductNewSearch}
              <input type="radio" name="clearSearch" value="N"/> ${uiLabelMap.ProductRefineSearch}
            </div>
        </td>
      </tr>
    </#if>
