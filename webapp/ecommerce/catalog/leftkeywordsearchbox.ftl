...
<form name="keywordsearchform" method="post" action="<@ofbizUrl>leftkeywordsearch?VIEW_SIZE=25&amp;PAGING=Y</@ofbizUrl>" style="margin: 0;">
  <input type="hidden" name="SEARCH_SUPPLIER_ID" value="${userLogin.partyId}"/>
...
<form name="advancedsearchform" method="post" action="<@ofbizUrl>advancedproductsearch</@ofbizUrl>" style="margin: 0;">
  <span class="label">
    ${uiLabelMap.ProductCategoryId}:
  </span>
