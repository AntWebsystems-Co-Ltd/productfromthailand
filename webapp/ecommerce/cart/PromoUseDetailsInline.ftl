...
<div id="main-container" class="container">
    <div class="panel-smart">
        <div class="panel-heading">
            <h3 class="panel-title">${uiLabelMap.OrderPromotionInformation}</h3>
        </div>
                    ...
                    <#list shoppingCart.getProductPromoUseInfoIter() as productPromoUseInfo>
                        <li>
                            ...
                            <#if productPromoUseInfo.productPromoCodeId?has_content>
                                <a href="<@ofbizUrl>removePromotion?promoCode=${productPromoUseInfo.productPromoCodeId?if_exists}</@ofbizUrl>" class="btn btn-main">${uiLabelMap.OrderRemovePromotion}</a>
                            </#if>
                        </li>
