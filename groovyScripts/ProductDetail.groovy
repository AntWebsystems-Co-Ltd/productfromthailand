...
currencyUomIdTo = UtilHttp.getCurrencyUom(request) ?: "THB";
...
if (product) {
    ...
    if (cart.isSalesOrder()) {
        ...
        priceContext = [product : product, prodCatalogId : catalogId,
            currencyUomId : currencyUomId, currencyUomIdTo : cart.getCurrency(), autoUserLogin : autoUserLogin];
        ...
        priceContext = [product : product, currencyUomId : currencyUomId, currencyUomIdTo : cart.getCurrency(),
