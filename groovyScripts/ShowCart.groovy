...
BigDecimal orderTotalShipping = shoppingCart.getTotalShipping()
BigDecimal orderTotalSalesTax = shoppingCart.getTotalSalesTax()
BigDecimal orderGrandTotal = shoppingCart.getDisplayGrandTotal()
if (shoppingCart.getTotalShipping() != BigDecimal.ZERO) {
    orderGrandTotal = orderGrandTotal.subtract(orderTotalShipping).subtract(orderTotalSalesTax)
}
