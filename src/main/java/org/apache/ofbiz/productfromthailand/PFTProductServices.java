...
public class PFTProductServices {
    ...
    public static String createProductAndUploadMultiImage(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException{
        ...
        try {
            ...
            Map<String, Object> fieldMap = UtilMisc.toMap("productId", formInput.get("productId"), "description", formInput.get("description"), "productTypeId", formInput.get("productTypeId"),"internalName"
                ...
                , productWeight, "weightUomId", formInput.get("weightUomId"), "userLogin", userLogin);

            if (formInput.get("dropship").equals("Y")) {
                fieldMap.put("requirementMethodEnumId", "PRODRQM_DS");
            } else {
                fieldMap.put("requirementMethodEnumId", null);
            }
